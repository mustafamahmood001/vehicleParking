        ...
        <div class="card-body position-relative">
          ...
          <form class="yourform" id="update-Vehiclecategory" action="" method="post" autocomplete="off">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control cat_name" placeholder="Name" name="cat_name" value="Category Name" required>
              </div>
              <div class="form-group">
                  <label>Parking Charges Per Hour</label>
                  <input type="number" class="form-control parking_charge" placeholder="Parking Charges Per Hour" name="parking_charge" value="parking_charge" required>
              </div>
              <div class="form-group">
                  <label>Status</label>
